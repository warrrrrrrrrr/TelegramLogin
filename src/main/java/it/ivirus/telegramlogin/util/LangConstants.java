...
public enum LangConstants {
    ...
    TG_ACCOUNT_LIST("info.telegram.accountList"),
    TG_ACCOUNT_STATUS("info.telegram.accountStatus"),
    TG_ACCOUNT_STATUS_LOCKED("info.telegram.accountStatusLocked"),
    TG_ACCOUNT_STATUS_UNLOCKED("info.telegram.accountStatusUnlocked"),
